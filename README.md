![docker image](https://github.com/RubelMozumder/nomad-distro-template-test-test/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/RubelMozumder/nomad-distro-template-test-test.git
    ...
    ```sh
    curl-L -o nomad-distro-template-test.zip "https://github.com/RubelMozumder/nomad-distro-template-test-test/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/rubelmozumder/nomad-distro-template-test-test:main` for the services
...
```sh
docker pull ghcr.io/rubelmozumder/nomad-distro-template-test-test/jupyter:main
```
...
For detailed instructions on how to resolve the merge conflicts between different version we refer you to the latest template release [notes](https://github.com/RubelMozumder/nomad-distro-template-test-test/releases/latest)
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/RubelMozumder/nomad-distro-template-test-test/manifests/main": unauthorized`
